...
[![Build Status](https://travis-ci.org/vikashvverma/eventers.svg?branch=master)](https://travis-ci.org/vikashvverma/eventers)
[![codecov](https://codecov.io/gh/vikashvverma/eventers/branch/master/graph/badge.svg)](https://codecov.io/gh/vikashvverma/eventers)
[![Go Report Card](https://goreportcard.com/badge/github.com/vikashvverma/eventers)](https://goreportcard.com/report/github.com/vikashvverma/eventers)
[![Maintainability](https://api.codeclimate.com/v1/badges/c3cb09dbc0bc43186464/maintainability)](https://codeclimate.com/github/vikashvverma/eventers/maintainability)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/vikashvverma/eventers-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/vikashvverma/eventers` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/vikashvverma/eventers` with `github.com/author/project`.

2. Rename the gorsk package inside `pkg/utl/model` with your own project name, then using search & replace do a global replacement of `eventers` with your project name.
