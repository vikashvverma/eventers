...
import (
	...
	"github.com/vikashvverma/eventers/pkg/api/password/platform/pgsql"
...
func TestView(t *testing.T) {
	...
	db := mock.NewDB(t, dbCon, &eventers.Role{}, &eventers.User{})

	if err := mock.InsertMultiple(db, &eventers.Role{
		ID:          1,
		AccessLevel: 1,
