...
func (u *User) Create(c echo.Context, req eventers.User) (*eventers.User, error) {
...
func (u *User) List(c echo.Context, p *eventers.Pagination) ([]eventers.User, error) {
	au := u.rbac.User(c)
	q, err := query.List(au)
	if err != nil {
		return nil, err
...
func (u *User) View(c echo.Context, id int) (*eventers.User, error) {
...
func (u *User) Update(c echo.Context, req *Update) (*eventers.User, error) {
