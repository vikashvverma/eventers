...
func (u *User) List(db orm.DB, qp *eventers.ListQuery, p *eventers.Pagination) ([]eventers.User, error) {
	var users []eventers.User
...
func (u *User) Delete(db orm.DB, user *eventers.User) error {
