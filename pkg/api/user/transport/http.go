...
type createReq struct {
	...
	RoleID     eventers.AccessRole `json:"role_id" validate:"required"`
}
...
func (h *HTTP) create(c echo.Context) error {
	...
	if r.RoleID < eventers.SuperAdminRole || r.RoleID > eventers.UserRole {
		return eventers.ErrBadRequest
	}

	usr, err := h.svc.Create(c, eventers.User{
		Username:   r.Username,
		Password:   r.Password,
		Email:      r.Email,
