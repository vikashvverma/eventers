...
func New(svc user.Service, logger eventers.Logger) *LogService {
	return &LogService{
		Service: svc,
		logger:  logger,
	}
...
// Create logging
func (ls *LogService) Create(c echo.Context, req eventers.User) (resp *eventers.User, err error) {
...
// List logging
func (ls *LogService) List(c echo.Context, req *eventers.Pagination) (resp []eventers.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// View logging
func (ls *LogService) View(c echo.Context, req int) (resp *eventers.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// Update logging
func (ls *LogService) Update(c echo.Context, req *user.Update) (resp *eventers.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
