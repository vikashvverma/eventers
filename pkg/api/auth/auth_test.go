...
func TestAuthenticate(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByUsernameFn: func(db orm.DB, user string) (*eventers.User, error) {
		...
		},
		{
			...
			jwt: &mock.JWT{
				GenerateTokenFn: func(u *eventers.User) (string, string, error) {
...
func TestRefresh(t *testing.T) {
	...
	cases := []struct {
		name     string
		args     args
		wantData *eventers.RefreshToken
		wantErr  bool
		udb      *mockdb.User
		jwt      *mock.JWT
	}{
		{
			...
			wantErr: true,
			udb: &mockdb.User{
				FindByTokenFn: func(db orm.DB, token string) (*eventers.User, error) {
					return nil, eventers.ErrGeneric
				},
			},
		},
